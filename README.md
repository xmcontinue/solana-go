...
[![GoDoc](https://pkg.go.dev/badge/github.com/xmcontinue/solana-go?status.svg)](https://pkg.go.dev/github.com/xmcontinue/solana-go@v1.8.4?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/xmcontinue/solana-go/releases)
[![Build Status](https://github.com/xmcontinue/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/xmcontinue/solana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/xmcontinue/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/xmcontinue/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/xmcontinue/solana-go)](https://goreportcard.com/report/github.com/xmcontinue/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/xmcontinue/solana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/xmcontinue/solana-go@v1.8.4
```
...
You can wait for a transaction confirmation using the `github.com/xmcontinue/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/xmcontinue/solana-go/programs/address-lookup-table"
...
import (
  ...
  "github.com/xmcontinue/solana-go/programs/system"
  "github.com/xmcontinue/solana-go/rpc"
  confirm "github.com/xmcontinue/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/xmcontinue/solana-go/rpc/jsonrpc"
