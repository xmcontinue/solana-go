...
type SwapCountKLine struct {
	...
	SwapAddress           string          `json:"swap_address" gorm:"not null;type:varchar(64);  uniqueIndex:swap_count_k_line_date_swap_address_unique_key; index;index:swap_count_k_line_date_type_swap_address_date,priority:2"` // swap地址
	...
	DateType              DateType        `json:"date_type"  gorm:"not null;type:varchar(64);  uniqueIndex:swap_count_k_line_date_swap_address_unique_key; index:swap_count_k_line_token_a_symbol_date_type_date;index:swap_count_k_line_token_b_symbol_date_type_date;index:swap_count_k_line_date_type_swap_address_date,priority:1"` // 时间类型（min,quarter,hour,day,wek,mon）
	Date                  *time.Time      `json:"date" gorm:"not null;type:timestamp(6);uniqueIndex:swap_count_k_line_date_swap_address_unique_key; index:swap_count_k_line_token_a_symbol_date_type_date;index:swap_count_k_line_token_b_symbol_date_type_date;index;index:swap_count_k_line_date_type_swap_address_date,priority:3"`  // 统计日期
	TxNum                 int64           `json:"tx_num"`                                                                                                                                                                                                                                                                               // 交易笔数
