...
type PositionCountSnapshot struct {
	...
	Date         string          `json:"date" gorm:"not null;uniqueIndex:positions_count_snapshot_user_address_swap_address_position_id_date_unique_key"`                          // 统计日期
...
type PositionV2Snapshot struct {
	...
	Date             string          `json:"date" gorm:"not null;uniqueIndex:positions_V2_snapshot_user_address_swap_address_position_id_date_unique_key"` // 统计日期
