...
//
//		// 更新处理数据的位置
//		if err = u.UpdateLastTransActionID(); err != nil {
//			return errors.Wrap(err)
//		}
//
...
//		for _, swapRecord := range u.Tx.GetTx().SwapRecords {
//			// 仅当前swapAccount  可以插入
...
//		}
//
//		for _, liquidity := range u.Tx.GetTx().LiquidityRecords {
//			// 仅当前swapAccount  可以插入
...
//		}
//
//		for _, claim := range u.Tx.GetTx().ClaimRecords {
//			// 仅当前swapAccount  可以插入
...
//}
//
//func (u *UserCount) UpdateLastTransActionID() error {
//	maxID, err := model.GetMaxUserCountKLineID(context.TODO(), u.SwapAccount)
//	if err != nil && !errors.Is(err, errors.RecordNotFound) {
//		return errors.Wrap(err)
//	}
//
//	if err = model.UpdateUserCountKLine(context.TODO(), map[string]interface{}{"last_swap_transaction_id": u.ID}, model.SwapAddressFilter(u.SwapAccount), model.NewFilter("last_swap_transaction_id = ?", maxID)); err != nil {
//		return errors.Wrap(err)
//	}
//	return nil
//}
